...
| `testar-medias.cjs` | a média do período nos cinco blocos com gráfico: pontilhado próprio, só meses realizados, teto e projeção sem média, um mês não produz reta, e o interruptor guarda o que foi desligado |
